...
import CrearEditarMarca from '../../pages/Admin/marcas/CrearEditarMarca'; 
...
describe('CrearEditarMarca Componente', () => {
    ...
    it('debe renderizar en modo "Crear marca" y con el campo de nombre vacío', () => {
        render(
            <CrearEditarMarca 
                isOpen={true} 
                onClose={mockOnClose} 
        ...
        expect(screen.getByTestId('modal-title')).toHaveTextContent('Crear marca');
    ...
    it('debe renderizar en modo "Editar marca" y cargar los datos iniciales', () => {
        const testData = { id: 15, nombre: "Marca de Prueba D&G" };
        ...
        expect(screen.getByTestId('modal-title')).toHaveTextContent('Editar marca');
